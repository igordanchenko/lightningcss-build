...
Thank you for helping keep `lightningcss-build` and its users safe.
...
[private vulnerability reporting](https://github.com/igordanchenko/lightningcss-build/security/advisories/new).
...
`[lightningcss-build] security report`.
