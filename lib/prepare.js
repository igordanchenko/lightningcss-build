...
import {
  ...
  assertOutputsDoNotOverwriteEntries,
  resolveEntries,
  validateInputDir,
} from "./resolve.js";
import { resolveTargets } from "./targets.js";

export async function prepare({ patterns, inputDir, outputDir, cwd = process.cwd(), log }) {
  ...
  assertOutputsDoNotOverwriteEntries(entries, inputDir, outputDir);
